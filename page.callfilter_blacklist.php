...
<h2><?php echo _("Add Blacklist Entry"); ?></h2>
<a href="<?php echo $_SERVER['PHP_SELF']; ?>?display=callfilter_whitelist">Goto Manage Whitelist</a>
		...
		<tr>
			<td>
				<a href=# class="info">
					...
					<span>
						<?php echo _("This incoming number will be blocked unless it first matches an entry in the whitelist. To use the pattern matching rules below, prefix with an underscore."); ?>
						<br /><br />
						...
						<br /><br />
						<?php echo _("To block all incoming calls except those on the whitelist, add the _. pattern."); ?>
					</span>
				</a>:
			</td>
			<td>
		...
		<tr>
			<td>
				<a href=# class="info">
					...
					<span>
						<?php echo _("Name of this blacklist entry."); ?>
					</span>
				</a>:
			</td>
			<td>
...
<?php
// Get existing blacklist entries
